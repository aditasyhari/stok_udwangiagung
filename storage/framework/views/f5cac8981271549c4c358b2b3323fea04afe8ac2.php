        ...
        <div class="card card-default">
            ...
            <form action="\simpan-barang">
                <?php echo csrf_field(); ?>
                    ...
                    <div class="form-group">
                    <p class="font-weight-bold">Masukkan Kode Barang :</p>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\ud_wangiagung\resources\views//stok/tambah.blade.php ENDPATH**/ ?>